...
# Make a graph
gv.plot <- function(plot.parameters, bathy, region) {

  corDir <- "/Volumes/Benguela/spatial/processed/WBC/misc_results"
  load(paste0(corDir, "/", region, "_correlations_v3.RData"))
  cor <- eval(parse(text = paste0(region, ".cor")))
