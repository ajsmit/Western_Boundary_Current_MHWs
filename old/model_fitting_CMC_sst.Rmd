...
sst.in <- as.tibble(fread("/Volumes/Benguela/spatial/processed/CMC0.2deg-CMC-L4-GLOB-v2.0/WBC/subregions/all-sub-summarised-CMC0.2deg-GLOB-v02.0-19910901-20170317.csv"))
sst <- sst.in %>%
  mutate(t = fastDate(t)) %>%
