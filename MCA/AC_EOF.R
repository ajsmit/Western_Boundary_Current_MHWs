# The data field is a matrix consisting of ~ 7300+ spatial locations (~ 4.5 km resolution); each column being a time series of one of these spatial locations.
# For the SST data, transform the 2D lat, lon matrix to a 1D vector (1 column x [lat x lon] rows), and place the time steps one after the other as columns
#
#
