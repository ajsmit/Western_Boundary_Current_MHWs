...
fwrite(AC_clim,
       file = paste0(clDir, "/AC-avhrr-only-v2.19810901-20180930_climatology.csv"),
       append = FALSE)
...
fwrite(BC_clim,
       file = paste0(clDir, "/BC-avhrr-only-v2.19810901-20180930_climatology.csv"),
       append = FALSE)
...
fwrite(EAC_clim,
       file = paste0(clDir, "/EAC-avhrr-only-v2.19810901-20180930_climatology.csv"),
       append = FALSE)
