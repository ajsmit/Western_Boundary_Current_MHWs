# 4.3.Aviso+_monthlyMeanTrends.R
...
AC <- as_tibble(fread(paste0(csvDir, "/AC-dataset-duacs-rep-global-merged-allsat-phy-l4-v3.csv"),
...
BC <- as_tibble(fread(paste0(csvDir, "/BC-dataset-duacs-rep-global-merged-allsat-phy-l4-v3.csv"),
                      colClasses = list("numeric" = 1:2, "myDate" = 3, "numeric" = 4:7),
                      col.names = c("lon", "lat", "time", "u", "v", "sla", "adt")))
...
EAC <- as_tibble(fread(paste0(csvDir, "/EAC-dataset-duacs-rep-global-merged-allsat-phy-l4-v3.csv"),
                       colClasses = list("numeric" = 1:2, "myDate" = 3, "numeric" = 4:7),
                       col.names = c("lon", "lat", "time", "u", "v", "sla", "adt")))
...
GS <- as_tibble(fread(paste0(csvDir, "/GS-dataset-duacs-rep-global-merged-allsat-phy-l4-v3.csv"),
                      colClasses = list("numeric" = 1:2, "myDate" = 3, "numeric" = 4:7),
                      col.names = c("lon", "lat", "time", "u", "v", "sla", "adt")))
...
KC <- as_tibble(fread(paste0(csvDir, "/KC-dataset-duacs-rep-global-merged-allsat-phy-l4-v3.csv"),
                      colClasses = list("numeric" = 1:2, "myDate" = 3, "numeric" = 4:7),
                      col.names = c("lon", "lat", "time", "u", "v", "sla", "adt")))
