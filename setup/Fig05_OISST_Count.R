...
AC.fig05 <- gv.plot(AC_totalCount, AC.layers, AC_bathy)
BC.fig05 <- gv.plot(BC_totalCount, BC.layers, BC_bathy)
EAC.fig05 <- gv.plot(EAC_totalCount, EAC.layers, EAC_bathy)
GS.fig05 <- gv.plot(GS_totalCount, GS.layers, GS_bathy)
KC.fig05 <- gv.plot(KC_totalCount, KC.layers, KC_bathy)
