...
AC.fig09 <- gv.plot(AC_Duration, AC.layers, AC_bathy)
BC.fig09 <- gv.plot(BC_Duration, BC.layers, BC_bathy)
EAC.fig09 <- gv.plot(EAC_Duration, EAC.layers, EAC_bathy)
KC.fig09 <- gv.plot(KC_Duration, KC.layers, KC_bathy)
GS.fig09 <- gv.plot(GS_Duration, GS.layers, GS_bathy)
